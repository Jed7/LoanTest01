...
print("User 1 has an initial balance of: " + str(bal_user1) + (" ETH"))
print("User 2 has an initial balance of: " + str(bal_user2) + (" ETH"))
...
print("User 1 has " + str(percent_capi_user1) + (" % of the capital"))
print("User 2 has " + str(percent_capi_user2) + (" % of the capital"))
...
print("User 1 has just made a profit of " + str(user1_profit) + (" ETH"))
...
print("Before a 5% fees, User 2 has made a profit of " + str(user2_profit_brut) + (" ETH"))

# Calculate profit of user2, after 5% fees
fees = (user2_profit_brut) * 5/100 
user2_profit_net = user2_profit_brut - fees
print("After 5% fees, User 2 has made a profit of " + str(user2_profit_net) + (" ETH"))
...
print("User 1 has a capital of " + str(new_bal_user1))
print("User 2 has a capital of " + str(new_bal_user2))
